...
public final class NaturesAppetiteServerConfig {
    ...
    private static final ModConfigSpec.BooleanValue ENABLE_AUTO_FEED = BUILDER
            .comment("Master switch for automatic feeding and breeding.")
            .define("enableAutoFeed", true);

    private static final ModConfigSpec.BooleanValue ENABLE_ADULT_CONTINUOUS_FEEDING = BUILDER
